...
public record TriggerSpellFXPayload(int entityId, SpellType<?> spellType, int castId, EffectData effectData) implements CustomPacketPayload {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, TriggerSpellFXPayload> STREAM_CODEC = StreamCodec.composite(
            ...
            EffectData.STREAM_CODEC, TriggerSpellFXPayload::effectData,
