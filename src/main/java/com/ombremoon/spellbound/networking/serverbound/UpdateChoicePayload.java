...
public record UpdateChoicePayload(SpellType<?> spellType, SkillProvider skill) implements CustomPacketPayload {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, UpdateChoicePayload> STREAM_CODEC = StreamCodec.composite(
            ...
            SkillProvider.STREAM_CODEC, UpdateChoicePayload::skill,
