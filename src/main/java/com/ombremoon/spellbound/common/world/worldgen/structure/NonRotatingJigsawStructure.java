package com.ombremoon.spellbound.common.world.worldgen.structure;

import com.mojang.serialization.Codec;
import com.mojang.serialization.DataResult;
import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import com.ombremoon.spellbound.common.init.SBStructures;
...
public class NonRotatingJigsawStructure extends Structure {
    ...
    public static final MapCodec<NonRotatingJigsawStructure> CODEC = RecordCodecBuilder.<NonRotatingJigsawStructure>mapCodec(
                    p_227640_ -> p_227640_.group(
                            ...
                            .apply(p_227640_, NonRotatingJigsawStructure::new)
            )
            .validate(NonRotatingJigsawStructure::verifyRange);
    ...
    private static DataResult<NonRotatingJigsawStructure> verifyRange(NonRotatingJigsawStructure structure) {
    ...
    public NonRotatingJigsawStructure(
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        return NonRotatingJigsawPlacement.addPieces(
                context,
                this.startPool,
    ...
    public StructureType<?> type() {
        return SBStructures.NON_ROTATING_JIGSAW.get();
    }
}
