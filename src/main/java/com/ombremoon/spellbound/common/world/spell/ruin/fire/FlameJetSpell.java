...
public class FlameJetSpell extends AnimatedSpell implements ChargeableSpell, RadialSpell {
    ...
    private static final OBBSentinelBox IRON_MAN_BOX = createIronMan();
    ...
    protected void onSpellStart(SpellContext context) {
        ...
        if (!context.getLevel().isClientSide) {
            if (context.isChoice(SBSkills.IRON_MAN)) {
                ...
                boxOwner.triggerSentinelBox(IRON_MAN_BOX);
                return;
            }
    ...
    protected void onSpellTick(SpellContext context) {
        ...
        if (!level.isClientSide) {
            ...
            } else if (this.tickCount == 5 && context.hasSkill(SBSkills.JET_ENGINE) && !context.isChoice(SBSkills.FLAME_GEYSER) && !context.isChoice(SBSkills.FLAME_INFERNO)) {
                Vec3 lookVec = caster.getLookAngle();
                double strength = 1.0F + (Math.min(this.turbulenceCharges + this.getCharges(), 6) * 0.25F);
                Vec3 motion = new Vec3(-lookVec.x * strength, -lookVec.y * strength, -lookVec.z * strength);
    ...
    public boolean canCharge(SkillTester skills) {
        return skills.test(SBSkills.TURBO_CHARGE);
    }
    ...
    private static OBBSentinelBox createFlameJet(int charges) {
        ...
        return OBBSentinelBox.Builder.of(name)
                ...
                .activeTicks((entity, integer) -> integer == 5)
                ...
                .onCollisionTick((entity, livingEntity) -> {
                    if (entity instanceof LivingEntity caster) {
                        ...
                        if (spell != null) {
                            ...
                            if (context.isChoice(SBSkills.FLAME_INFERNO))
                                damage *= 0.5F;
        ...
        return AABBSentinelBox.Builder.of(name)
                ...
                .setPosition((entity, partialTick) -> {
                    ...
                    if (spell != null) {
                        ...
                        Entity target = spell.getTargetEntity(livingEntity, castRange);
                        if (target != null) {
                            return target.getPosition(partialTick);
                        }

                        return spell.getSpawnPos(castRange).getBottomCenter();
                    }
                    ...
                    if (entity instanceof LivingEntity caster) {
                        ...
                        if (spell != null) {
                            ...
                            if (spell.hurt(livingEntity, damage) && context.hasSkill(SBSkills.EXPULSION_BLAST)) {
                                ...
                                livingEntity.setDeltaMovement(livingEntity.getDeltaMovement().add(upwardMotion));
    ...
    private static OBBSentinelBox createIgnitionBurst(int charges) {
        ...
        return OBBSentinelBox.Builder.of(name)
                ...
                .onBoxTick((entity, instance) -> {
                    ...
                    if (!level.isClientSide && instance.tickCount == 5) {
    ...
    private static OBBSentinelBox createIronMan() {
